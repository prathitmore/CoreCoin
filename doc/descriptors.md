# Support for Output Descriptors in CoreCoin Core

Since CoreCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `CORE1...` for mainnet or `tCORE1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing CoreCoin Core wallets, a convenience function `combo` is
