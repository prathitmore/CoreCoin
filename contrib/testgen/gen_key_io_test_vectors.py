...
bech32_templates = [
  ...
  ('CORE',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('CORE',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('CORE',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('CORE',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tCORE',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tCORE',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tCORE',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tCORE',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tCORE',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tCORE',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tCORE',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tCORE',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rCORE',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rCORE',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rCORE',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rCORE', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tCORE',   17, 32, Encoding.BECH32M, False, False, False),
  ('rCORE',  3,  1, Encoding.BECH32M, False, False, False),
  ('CORE',   15, 41, Encoding.BECH32M, False, False, False),
  ('tCORE',    0, 16, Encoding.BECH32,  False, False, False),
  ('rCORE',  0, 32, Encoding.BECH32,  True,  False, False),
  ('CORE',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tCORE',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rCORE',  0, 20, Encoding.BECH32,  False, False, True),
  ('CORE',    0, 20, Encoding.BECH32M, False, False, False),
  ('tCORE',    0, 32, Encoding.BECH32M, False, False, False),
  ('rCORE',  0, 20, Encoding.BECH32M, False, False, False),
  ('CORE',    1, 32, Encoding.BECH32,  False, False, False),
  ('tCORE',    2, 16, Encoding.BECH32,  False, False, False),
  ('rCORE', 16, 20, Encoding.BECH32,  False, False, False),
]
