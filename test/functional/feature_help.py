...
"""Verify that starting CoreCoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start CoreCoin with -h for help text")
        ...
        self.log.info("Start CoreCoin with -version for version information")
        ...
        self.log.info("Start CoreCoind with -fakearg to make sure it does not start")
