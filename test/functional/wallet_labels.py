...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rCORE10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqevpw9x',
            '✔️_VER16_PROG03': 'rCORE1sqqqqqap5g4h',
            '✔️_VER16_PROB02': 'rCORE1sqqqqfsjxnh',
        }
        BECH32_INVALID = {
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid CoreCoin address or script",
