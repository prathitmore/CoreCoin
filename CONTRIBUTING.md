Contributing to CoreCoin Core
============================

The CoreCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the CoreCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/CoreCoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to CoreCoin-qt
...
The following applies to code changes to the CoreCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CoreCoin
Network Protocol consensus changes.

Whether a pull request is merged into CoreCoin Core rests with the project merge
...
Patches that change CoreCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CoreCoin consensus, it must have been
...
The project leader is the release manager for each CoreCoin Core release.
