...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " CoreCoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  CoreCoin-tx [options] <hex-tx> [commands]  Update hex-encoded CoreCoin transaction\n" +
            "or:     CoreCoin-tx [options] -create [commands]   Create hex-encoded CoreCoin transaction\n" +
            "\n";
