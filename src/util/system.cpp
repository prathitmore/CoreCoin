...
const char * const BITCOIN_CONF_FILENAME = "CoreCoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CoreCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CoreCoin";
#else
    // Unix-like
    return pathRet / ".CoreCoin";
#endif
#endif
}
